...
?>
    ...
    echo "<tr bgcolor='#FF9933'>
        ...
        <td><input class='form-control' type='text' name='apel[]' value=' $ape[$i]' readonly></td>
        <td><input class='form-control' type='number' name='sal[]' value='$sal[$i]' readonly></td>
        <td><input class='form-control' type='number' name='sal2[]' value='$s' readonly></td>
