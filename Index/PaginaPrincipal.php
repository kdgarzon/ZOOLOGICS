...
<body>
        ...
        <nav class="Barra_Navegacion">
            ...
            <div class="botones">
                <div class="btn_ingresar">
                    <img src="../Imagenes/Iconos/usuario.png" alt="" width="32px" height="32px">
                    <a href="../Login/login.php">Iniciar sesión</a>
                </div>
                <div class="btn_registrar">
                    <a href="../Login/RegistrarUser.php">Registrarse</a>
                </div>
            </div>
        </nav>
    </header>
    <div class="grupo_tarjetas">
        <div class="tarjeta">
            ...
            <h1 class="tituloDos">SAN DIEGO</h1>
        ...
        <div class="tarjeta">
            <h3 class="tituloUno">ZOOLOGICO</h3>
            <h1 class="tituloDos">SINGAPUR</h1>
            <p class="textoEntrada">
        ...
        <div class="tarjeta">
            <h3 class="tituloUno">ZOOLOGICO</h3>
            <h1 class="tituloDos">LORO PARQUE</h1>
            <p class="textoEntrada">
        ...
        <div class="tarjeta">
            <h3 class="tituloUno">ZOOLOGICO</h3>
            <h1 class="tituloDos">SCHONBRUNN</h1>
            <p class="textoEntrada">
        ...
        <div class="tarjeta">
            <h3 class="tituloUno">ZOOLOGICO</h3>
            <h1 class="tituloDos">BRONX</h1>
            <p class="textoEntrada">
                Es el zoológico más grande de América del Norte con unos 6.000 animales que representan más o menos a 
        ...
        <div class="tarjeta">
            <h3 class="tituloUno">ZOOLOGICO</h3>
            <h1 class="tituloDos">CHAPULTEPEC</h1>
            <p class="textoEntrada">
                Es el zoológico más visitado de México. Dada su orientación científica hacia el cuidado de la protección
        ...
        <div class="tarjeta">
            ...
            <h1 class="tituloDos">TWO OCEANS</h1>
            <p class="textoEntrada">
    ...
    <script>
        ...
        // Función para mostrar la siguiente tarjeta en el carrusel
        ...
        // Intervalo para cambiar de tarjeta cada ciertos segundos (por ejemplo, 5 segundos)
