...
<body>
    ...
    <div class="PrimerZoo">
        <div class="vista">
            ...
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de San Diego</h2>
                <p class="texto">
    ...
    <div class="SegundoZoo">
        <div class="vista">
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Singapur</h2>
                <p class="texto">
    ...
    <div class="Tercerzoo">
        <div class="vista">
            ...
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Toronto</h2>
                <p class="texto">
    ...
    <div class="CuartoZoo">
        <div class="vista">
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico Loro Parque</h2>
                <p class="texto">
    ...
    <div class="QuintoZoo">
        <div class="vista">
            ...
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Schonbrunn</h2>
                <p class="texto">
    ...
    <hr clss="linea_divisora">
    <div class="SextoZoo">
        <div class="vista">
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Londres</h2>
                <p class="texto">
    ...
    <div class="SeptimoZoo">
        <div class="vista">
            ...
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Berlín</h2>
                <p class="texto">
    ...
    <div class="OctavoZoo">
        <div class="vista">
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico del Bronx</h2>
                <p class="texto">
    ...
    <div class="NovenoZoo">
        <div class="vista">
            ...
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Zoológico de Chapultepec</h2>
                <p class="texto">
    ...
    <div class="DecimoZoo">
        <div class="vista">
            <div class="contenido-zoo">
                <h2 class="subtitulo-zoo">Acuario Two Oceans</h2>
                <p class="texto">
